  ...
  return (
    <div className="flex flex-col gap-6 sm:gap-8 lg:gap-10 w-full min-h-0 animate-in fade-in duration-200">
      <div className="flex flex-col gap-2">
        ...
        <div
          className="h-4 w-64 rounded-xl bg-muted/70 animate-pulse"
          style={{ animationDelay: "100ms" }}
        />
      </div>
      <div className="grid gap-6 sm:grid-cols-2">
        <div
          className={cn(appSurfaceCardClass, "h-[180px] animate-pulse")}
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        <div
          className={cn(appSurfaceCardClass, "h-[220px] animate-pulse")}
